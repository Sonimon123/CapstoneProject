...
#CSV Order: ID, Name, Average Rating, Release Year, Min PLayers, Max Players,
#           Playtime, age, average weight, Does it fit category bools, 
#           mechanic bools, reimplement bool (Reimagining), expansion count
